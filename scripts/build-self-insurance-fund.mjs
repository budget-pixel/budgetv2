...
<div class="reserve"><div class="reserve-head"><h2>Reserve Position</h2></div>
  ...
  <div class="callout"><strong>Fully funded</strong><span>With the FY2027 premium increase reflected in the plan's projected claims, the current $3,668,000 reserve allocation provides approximately ${currentDays.toFixed(0)} days of budgeted cost coverage, meeting the 74-day target.</span></div>
</div>
<div class="grid">
...
<p class="note">Methodology: reserve-day coverage reflects the plan's projected claims following the FY2027 premium increase. The current reserve reflects the $3,668,000 reserve allocation approved by the Board on September 8, 2026. Figures are rounded for presentation.</p>
