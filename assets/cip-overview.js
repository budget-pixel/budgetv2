...
function describeCipTrend(yearTotals){
  ...
  return {
    ...
    detail: (risenInto
      ...
      : "") +
      "From " + first.label + " to " + last.label + " the final plan " + planDirection + " by " +
...
function renderProjects(){
  ...
  app.innerHTML = `
    ...
    <p class="page-intro">Capital projects turn revenue into roads, buildings, parks, and utility systems that serve the public for years. This page walks through what counts as a capital project, what goes into one, and why new projects are necessary.</p>
    ` : ""}
